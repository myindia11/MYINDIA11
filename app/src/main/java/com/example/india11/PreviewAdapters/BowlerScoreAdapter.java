...
public class BowlerScoreAdapter extends RecyclerView.Adapter<BowlerScoreAdapter.ViewHolder> {
    ...
    public BowlerScoreAdapter(Context context, List<BowlPreviewModel> selectedPlayersModelList) {
                        ...
                        if (snapshot.exists()){
                            ...
                            if (selectedPlayersModel.getCap().equals("YES")){
                                ...
                                databaseReference.child("FinalCreatedTeamsPlayer").child(uid).child(Common.avlContestId)
                                        .child(Common.teamCode).child("Bowler")
