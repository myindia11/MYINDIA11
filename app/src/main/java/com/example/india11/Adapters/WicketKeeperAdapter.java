...
import com.example.india11.Model.WicketKeeperModel;
...
public class WicketKeeperAdapter extends RecyclerView.Adapter<WicketKeeperAdapter.ViewHolder> {
    ...
    int totalWicketKeepers, totalSelectedPlayers,selectedBy;
    Double creditsLeft,percent;
    String tag;
    boolean selected = false;

    public WicketKeeperAdapter(Context context, List<PlayersListModel> playersListModelList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        databaseReference6.child("FinalCreatedTeamsPlayer").child(uid).child(Common.avlContestId).child(Common.teamCode).child("WicketKeeper")
        ...
        holder.type.setText("Wicket Keeper");
        ...
        holder.plus.setOnClickListener(view -> {
            ...
            if (totalWicketKeepers == 4){
                //Toast.makeText(context, "Maximum wicket keepers selected.", Toast.LENGTH_SHORT).show();
                toastMessage.setText("Maximum wicket keepers selected.");
                toastDialog.show();
        ...
        holder.minus.setOnClickListener(view -> {
                ...
                pid = playersListModelList.get(position).getPid();
                playerRole = "WicketKeeper";
                databaseReference4.child("FinalCreatedTeamsPlayer").child(uid).child(Common.avlContestId).child(teamCode).child(playerRole).child(pid).removeValue();
