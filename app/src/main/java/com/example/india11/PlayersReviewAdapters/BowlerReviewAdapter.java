...
public class BowlerReviewAdapter extends RecyclerView.Adapter<BowlerReviewAdapter.ViewHolder> {
    ...
    public BowlerReviewAdapter(Context context, List<PlayersListModel> playersListModelList) {
