...
public class WicketReviewAdapter extends RecyclerView.Adapter<WicketReviewAdapter.ViewHolder> {
    ...
    public WicketReviewAdapter(Context context, List<PlayersListModel> playersListModelList) {
