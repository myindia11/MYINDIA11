...
import com.example.india11.EditTeam.EditBatsman;
...
public class BatPreviewAdapter extends RecyclerView.Adapter<BatPreviewAdapter.ViewHolder> {
    public Context context;
    private List<BatPreviewModel> selectedPlayersModelList;
    ...
    private ArrayList<PlayersListModel> playersListModelListAr = new ArrayList<>();
    ...
    public BatPreviewAdapter(Context context, List<BatPreviewModel> selectedPlayersModelList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        BatPreviewModel selectedPlayersModel = selectedPlayersModelList.get(position);
            ...
            databaseReferencePlayers.child("AvailableContests").child(Common.avlContestId).child("Players").child("Batsman")
                    .addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            BatListAdapter batsmanAdapter = new BatListAdapter(context,playersListModelList);
        ...
        arLayout.setOnClickListener(view -> {
            ...
            databaseReferencePlayers.child("AvailableContests").child(Common.avlContestId).child("Players").child("AllRounder")
                    .addValueEventListener(new ValueEventListener() {
                        @Override
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            playersListModelListAr.clear();
                            for (DataSnapshot dataSnapshot : snapshot.getChildren()){
                                PlayersListModel playersListModel = dataSnapshot.getValue(PlayersListModel.class);
                                playersListModelListAr.add(playersListModel);
                            }
                            AllListAdapter allRounderAdapter = new AllListAdapter(context,playersListModelListAr);
