...
public class SelectedPlayersModel {
    ...
    public SelectedPlayersModel(String teamName, String playerName, String pid, String playerStatus, String playerRole, String playerPic, Double creditScore, Double obtainedPoints, Boolean isSelected, String cap, String vcap) {
        this.teamName = teamName;
        this.playerName = playerName;
        this.pid = pid;
        this.playerStatus = playerStatus;
