...
import com.example.india11.Adapters.LiveMatchAdapter;
import com.example.india11.Common;
import com.example.india11.Model.AvailableContestsModel;
import com.example.india11.R;
import com.example.india11.databinding.FragmentLiveBinding;
...
public class Live extends Fragment {
    ...
    String UID;
    private LiveMatchAdapter joinedSubContestsAdapter;
        ...
        databaseReference.child("UsersJoinedLeague").child(UID).child("Contests").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    joinedSubContestsAdapter = new LiveMatchAdapter(getContext(),availableContestsModel);
