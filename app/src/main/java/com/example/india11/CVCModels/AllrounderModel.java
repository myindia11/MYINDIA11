...
public class AllrounderModel {
    ...
    public AllrounderModel(String teamName, String playerName, String pid, String playerStatus, String playerPic, Double creditScore, Double obtainedPoints) {
        this.teamName = teamName;
        this.playerName = playerName;
        this.pid = pid;
        this.playerStatus = playerStatus;
