...
public class AllListAdapter extends ArrayAdapter<PlayersListModel>{
    ...
    public AllListAdapter(@NonNull Context context, ArrayList<PlayersListModel> playersListModelArrayList) {
