...
public class CompletedMatchAdapter extends RecyclerView.Adapter<CompletedMatchAdapter.ViewHolder> {
    ...
    public CompletedMatchAdapter(Context context, List<AvailableContestsModel> availableContestsModelList) {
