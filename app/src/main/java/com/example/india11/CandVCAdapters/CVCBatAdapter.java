...
public class CVCBatAdapter extends RecyclerView.Adapter<CVCBatAdapter.ViewHolder> {
    public Context context;
    private List<BatsmanModel> batsmanModelList;
    ...
    public CVCBatAdapter(Context context, List<BatsmanModel> batsmanModelList) {
        this.context = context;
        this.batsmanModelList = batsmanModelList;
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        BatsmanModel playersListModel = batsmanModelList.get(position);
                ...
                if (snapshot.exists()) {
                    ...
                    if (playersListModel.getPlayerName().equals(scap)) {
                        ...
                        databaseReference3.child("FinalCreatedTeamsPlayer").child(uid).child(Common.avlContestId).child(Common.teamCode)
                                .child("Batsman").child(playersListModel.getPid()).child("cap").setValue("NO");
                    }
                    if (playersListModel.getPlayerName().equals(svcap)) {
                        ...
                        databaseReference3.child("FinalCreatedTeamsPlayer").child(uid).child(Common.avlContestId).child(Common.teamCode)
                                .child("Batsman").child(playersListModel.getPid()).child("vcap").setValue("NO");
                    }
                }
            }
        ...
        holder.identification.setImageDrawable(ContextCompat.getDrawable(context,R.drawable.batsman_icon));
        ...
        holder.capBtn.setOnClickListener(view -> {
            ...
            captain = batsmanModelList.get(position).getPlayerName();
            viceCaptain = svcap;
            ...
            teamName = batsmanModelList.get(position).getTeamName();
            playerName = batsmanModelList.get(position).getPlayerName();
            pid = batsmanModelList.get(position).getPid();
            playerStatus = batsmanModelList.get(position).getPlayerStatus();
            playerRole = "Batsman";
            isSelected = true;
            creditScore = batsmanModelList.get(position).getCreditScore();
            obtainedPoints = batsmanModelList.get(position).getObtainedPoints();
            cap = "YES";
            vcap = "NO";
            playerPic = batsmanModelList.get(position).getPlayerPic();
        ...
        holder.vcapBtn.setOnClickListener(view -> {
            ...
            teamTwo = Common.teamTwoName;
            captain = scap;
            viceCaptain = batsmanModelList.get(position).getPlayerName();
            teamOneCount = tmOneCount;
            teamTwoCount = tmTwoCount;
            PlayerValuesModel playerValuesModel = new PlayerValuesModel(teamCode,leftCredit,WK,BT,AR,BR,teamOneCount,teamTwoCount,
                    teamOne, teamTwo, captain, viceCaptain);
