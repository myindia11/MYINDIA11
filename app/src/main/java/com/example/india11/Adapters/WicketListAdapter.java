...
public class WicketListAdapter extends ArrayAdapter<PlayersListModel> {
    int count = 0;
    ...
    public WicketListAdapter(@NonNull Context context, ArrayList<PlayersListModel> playersListModelArrayList) {
