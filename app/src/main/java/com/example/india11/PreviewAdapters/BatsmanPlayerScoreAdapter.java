...
public class BatsmanPlayerScoreAdapter extends RecyclerView.Adapter<BatsmanPlayerScoreAdapter.ViewHolder> {
    ...
    public BatsmanPlayerScoreAdapter(Context context, List<BatPreviewModel> selectedPlayersModelList) {
                        ...
                        if (snapshot.exists()){
                            ...
                            if (selectedPlayersModel.getCap().equals("YES")){
                                ...
                                databaseReference.child("FinalCreatedTeamsPlayer").child(uid).child(Common.avlContestId)
                                        .child(Common.teamCode).child("Batsman")
