...
import com.example.india11.EditTeam.EditWicketKeeper;
...
public class WicketPreviewAdapter extends RecyclerView.Adapter<WicketPreviewAdapter.ViewHolder> {
    ...
    public WicketPreviewAdapter(Context context, List<WicketPreviewModel> selectedPlayersModelList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        playerType.setText("Wicket Keeper");
            ...
            databaseReferencePlayers.child("AvailableContests").child(Common.avlContestId).child("Players").child("WicketKeeper")
                    .addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            WicketListAdapter wicketKeeperAdapter = new WicketListAdapter(context,playersListModelList);
