...
import com.example.india11.databinding.FragmentWicketListBinding;
...
public class WicketList extends Fragment {
    private FragmentWicketListBinding binding;
    ArrayList<PlayersListModel> playersListModelList1 = new ArrayList<>();
    DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference();
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        binding = FragmentWicketListBinding.inflate(inflater,container,false);
        ...
        databaseReference.child("AvailableContests").child(Common.avlContestId).child("Players").child("WicketKeeper")
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        binding.wicketList.setAdapter(wicketKeeperAdapter);
                    }
