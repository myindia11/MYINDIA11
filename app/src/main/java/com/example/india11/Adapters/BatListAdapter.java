...
public class BatListAdapter extends ArrayAdapter<PlayersListModel>{
    ...
    public BatListAdapter(@NonNull Context context, ArrayList<PlayersListModel> playersListModelArrayList) {
