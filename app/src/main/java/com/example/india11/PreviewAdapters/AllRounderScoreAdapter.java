...
public class AllRounderScoreAdapter extends RecyclerView.Adapter<AllRounderScoreAdapter.ViewHolder> {
    ...
    public AllRounderScoreAdapter(Context context, List<AllPreviewModel> selectedPlayersModelList) {
                        ...
                        if (snapshot.exists()){
                            ...
                            if (selectedPlayersModel.getCap().equals("YES")){
                                ...
                                databaseReference.child("FinalCreatedTeamsPlayer").child(uid).child(Common.avlContestId)
                                        .child(Common.teamCode).child("AllRounder")
