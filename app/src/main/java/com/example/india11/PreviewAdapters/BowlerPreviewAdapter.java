...
import com.example.india11.EditTeam.EditBowler;
...
public class BowlerPreviewAdapter extends RecyclerView.Adapter<BowlerPreviewAdapter.ViewHolder> {
    public Context context;
    private List<BowlPreviewModel> selectedPlayersModelList;
    ...
    public BowlerPreviewAdapter(Context context, List<BowlPreviewModel> selectedPlayersModelList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        BowlPreviewModel selectedPlayersModel = selectedPlayersModelList.get(position);
            ...
            databaseReferencePlayers.child("AvailableContests").child(Common.avlContestId).child("Players").child("Bowler")
                    .addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            BowlListAdapter bowlerAdapter = new BowlListAdapter(context,playersListModelList);
