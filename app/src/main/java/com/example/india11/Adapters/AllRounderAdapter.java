...
public class AllRounderAdapter extends RecyclerView.Adapter<AllRounderAdapter.ViewHolder> {
    ...
    int totalAllRounder, totalSelectedPlayers,selectedBy;
    Double creditsLeft,percent;
    String ar1, ar2, ar3, ar4;

    public AllRounderAdapter(Context context, List<PlayersListModel> playersListModelList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        databaseReference6.child("FinalCreatedTeamsPlayer").child(uid).child(Common.avlContestId).child(Common.teamCode).child("AllRounder")
        ...
        //holder.seriesPoint.setText(String.valueOf(playersListModel.getPreviousPoints()));

        holder.type.setText("All Rounder");
        holder.plus.setOnClickListener(view -> {
            ...
            if (totalAllRounder == 4){
                toastMessage.setText("Maximum all rounder selected.");
                toastDialog.show();
        ...
        holder.minus.setOnClickListener(view -> {
            ...
            databaseReference12.child("ContestSeries").child(Common.seriesId)
                    .child("AllPlayers").child(playersListModelList.get(position).getPid())
                    .child("selectedBy").setValue(selectedBy);
            databaseReference6.child("FinalCreatedTeamsPlayer").child(uid).child(Common.avlContestId).child(teamCode).child(playerRole).child(pid).removeValue();
