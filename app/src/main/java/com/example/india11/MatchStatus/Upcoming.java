...
import com.example.india11.databinding.FragmentUpcomingBinding;
        ...
        databaseReference.child("UsersJoinedLeague").child(UID).child("Contests").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    joinedSubContestsAdapter = new JoinedMatchAdapter(getContext(),availableContestsModel);
